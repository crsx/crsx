...
public class JoelFactory extends GenericFactory
{
    ...
    private class JavaExpression extends JavaLink
    {
         ...
         */
        JavaExpression(JavaLink parent, String pre, boolean literal1, String sep1, boolean literal2, String sep2, String sep3s, String post)
        {
            super(parent);
        ...
        void next(int n, boolean end)
        {
            switch (n)
            {
                case 0 : expression.append(pre); if (end) expression.append(post); break;
                case 1 : expression.append(sep1); if (end) expression.append(post); break;
                case 2 : expression.append(sep2); if (end) expression.append(post); break;
                default : expression.append(end ? post : sep3s); break;
            }
        }
        public Sink end()
        {

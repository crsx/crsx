...
/**
 * Extends map with safe addition of a single element to the image set.
 * @param <Key> hash key
 * @param <Value> hash value set member type
 * 
 * @author <a href="http://www.research.ibm.com/people/k/krisrose">Kristoffer Rose</a>.
 * @version $Id: MultiMap.java,v 3.0 2012/12/17 18:04:58 krisrose Exp $
 */
public interface MultiMap<Key,Value> extends Map<Key,Set<Value>>
{
	...
	/** Using this interferes with {@link MultiMap} functionality. */
    @Deprecated

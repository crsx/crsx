 ...
 * 
 * @author jjohann
 * @deprecated  This class doesn't work. Use StackedMap instead.
 */
public class StackedVariableMap<K> implements Map<K, K>
{

	private Stack<ExtensibleMap<K, K>> stack;

	public StackedVariableMap()
	{
		stack = new Stack<ExtensibleMap<K, K>>();
		stack.push(new LinkedExtensibleMap<K, K>());
	}
	...
	public K get(Object key)
	{
		...
		{
			ExtensibleMap<K, K> map = stack.get(i);
			K value = map.get(key);
			if (value != null)
			{
				return value;

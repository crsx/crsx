%% $Id: hacs-gently.tex,v 1.29 2014/02/11 15:49:11 krisrose Exp $
\documentclass[11pt]{article} %style: font size.
\input{setup}
\RCS$Id: hacs-gently.tex,v 1.29 2014/02/11 15:49:11 krisrose Exp $
\def\version{\thanks{\textbf{UNFINISHED DRAFT---Feedback Appreciated}---\RCSId.}}
...
\RCSdate$Date: 2014/02/11 15:49:11 $

 ...
 */
  final public void Grammar(Maker maker, String jjcrs, String sourcePrefix, boolean makeHtml,
        boolean makeConstants, boolean makeSerializer, Map<String, String> parserOptions) throws ParseException, IOException {String comment = null;
 ...
 */
  final public void ClassDirective(List<String> comments, String jjcrs, String sourcePrefix,
        boolean makeHtml, boolean makeConstants, boolean makeSerializer) throws ParseException, IOException {Token t, o;
        String n;
        String className, s;
 ...
 * Append HTML version of grammar to the html writer when non-null.
 */
  final public void Productions(Appendable javacc, Appendable html, Appendable serializer) throws ParseException, IOException {String comment, docComment = null;
 ...
 */
  final public void Structural(String comment, Appendable javacc, Appendable html, Appendable serializer) throws ParseException, IOException {Token t; // scratch token
 ...
 * @return HTML summary of production
 */
  final public void Lexical(String comment, Appendable javacc, Appendable html) throws ParseException, IOException {Token t; // scratch token
        String name; // production name
        StringBuilder body = new StringBuilder(); // production body text accumulator
        StringBuilder localHtml = new StringBuilder();
 ...
 * @param html where the HTML summary is appended, or null if none is needed
 */
  final public void Skip(String comment, Appendable html) throws ParseException, IOException {Token t; // scratch token
        StringBuilder body = new StringBuilder(); // production body text accumulator
        StringBuilder localHtml = new StringBuilder();
        List<String> states = new ArrayList<String>();
        String pre = "", post = "", statearg = "";
 ...
 * @param html where the HTML summary is appended, or null if none is needed
 */
  final public void Cast(String comment, Appendable javacc, Appendable html) throws ParseException, IOException {Token t; // scratch token
        StringBuilder b;
 ...
 * @param html where the HTML summary is appended, or null if none is needed
 */
  final public void Meta(String comment, Appendable javacc, Appendable html) throws ParseException, IOException {Token t; // scratch token
        StringBuilder body = new StringBuilder(); // production body text accumulator
        StringBuilder localHtml = new StringBuilder();
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case 23:{
 ...
 */
  final public Reverser.Builder TopConcatenation(String productionName, String topConstructor,
        ...
        Map<String, String> decls, Appendable body, Appendable html) throws ParseException, IOException {SourceBuilder production = new PlainSourceBuilder(body, "\u005ct");
 ...
 */
  final public Reverser.Builder Primary(String productionName, Map<String, String> decls, SourceBuilder production,
        ...
        Map<String, Variable> variables, Map<String, Triple<String, String, String>> metavariables) throws ParseException, IOException {Reverser.Builder rev = Reverser.dummy();
        String occ = "";
    label_10:
    while (true) {
      switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
 ...
 */
  final public Reverser.Builder Literal(String productionName, Map<String, String> decls, SourceBuilder production,
        StringBuilder endings, Appendable html, Map<Variable, String> variable2java,
        Map<String, Variable> variables, Map<String, Triple<String, String, String>> metavariables) throws ParseException, IOException {Token t;
        String literal;
        Usage use;
    t = jj_consume_token(STRING);
...
if (!use.touched)
                ...
                {if ("" != null) return Reverser.literal(literal, use);}
    throw new Error("Missing return statement in function");
  }
...
useUsage(use, ""+decls.size(), decls, production, endings, variable2java, variables, metavariables);
                {if ("" != null) return Reverser.inline(inline, use);}
    throw new Error("Missing return statement in function");
  }
...
if (!use.touched)
                ...
                {if ("" != null) return Reverser.terminal(terminal, use);}
      break;
      }
    default:
      jj_la1[54] = jj_gen;
...
/** Reference to nonterminal - with optional occurrence indicator. */
  final public String NonterminalName(Appendable html) throws ParseException, IOException {Token t;
        char repeater = 0;
        String nonterminal;
    jj_consume_token(LANGLE);
    t = Name();
...
// In all modes, documentation is just the nonterminal.
                ...
                switch (repeater)
                {
                        ...
                        case '*' :
                                ...
                                break;
                        default :
                                {if ("" != null) return nonterminal;}
                }
                derivedNonterminals.add(realNonterminal);
                {if ("" != null) return realNonterminal;}
    throw new Error("Missing return statement in function");
  }

/** Nonterminal reference. */
  final public Reverser.Builder Nonterminal(String productionName, Map<String, String> decls, SourceBuilder production, StringBuilder endings, Appendable html, Map<Variable, String> variable2java, Map<String, Variable> variables, Map<String, Triple<String, String, String>> metavariables) throws ParseException, IOException {Token t, t2;
        String nonterminal;
...
if (!use.touched)
                ...
                {if ("" != null) return Reverser.nonterminal(nonterminal, vs, use);}
    throw new Error("Missing return statement in function");
  }
...
if (text.startsWith(":"))
                ...
                {if ("" != null) return Reverser.generation(text);}
    throw new Error("Missing return statement in function");
  }
...
/** Choice. */
  final public Reverser.Builder Choice(String productionName, Map<String, String> decls, SourceBuilder production,
        ...
        Map<String, Triple<String, String, String>> metavariables) throws ParseException, IOException {StringBuilder localEndings;
        Reverser.Builder rev, rev2;
in(production);
...
/** Nested concatenation. */
  final public Reverser.Builder Concatenation(String productionName, Map<String, String> decls, SourceBuilder production,
        StringBuilder endings, Appendable html, Map<Variable, String> variable2java,
        Map<String, Variable> variables, Map<String, Triple<String, String, String>> metavariables) throws ParseException, IOException {Reverser.Builder rev, rev2;
    rev = Primary(productionName, decls, production, endings, html, variable2java, variables, metavariables);
    label_14:
    while (true) {
      switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
 ...
 */
  final public void Copy(String comment, Appendable javacc) throws ParseException, IOException {Token t;
    t = jj_consume_token(EMBEDDED);
{
                String s = t.toString();
 ...
 * @return HTML text describing the effect.
 */
  final public void Include(String comment, Appendable javacc, Appendable html, Appendable serializer) throws ParseException, IOException {Token t;
    jj_consume_token(32);
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case STRING:{
      t = jj_consume_token(STRING);
 ...
 */
  final public void Names(List<String> names) throws ParseException {Token t;
    t = Name();
...
/** Parse usage description. */
  final public Usage Use(String prefix, String initial, Appendable html, boolean isConstant) throws ParseException, IOException {Token t;
...
/** Parse and echo simple lexical tokens. */
  final public void LexicalSimple(String productionName, Appendable body, Appendable html) throws ParseException, IOException {Token t;
...
/** Parse and echo lexical character class. */
  final public void LexicalChars(String productionName, Appendable b, Appendable html) throws ParseException, IOException {Token t;
 ...
 */
  final public String Comment() throws ParseException, IOException {Token t;
...
/** Complex tokens. */
  final public Token Name() throws ParseException {Token t;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case VAR:{
      t = jj_consume_token(VAR);
      break;
...
{if ("" != null) return t;}
  ...
  final public Token MetaVar() throws ParseException {Token t;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case METAVAR:{

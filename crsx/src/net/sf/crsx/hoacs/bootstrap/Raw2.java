/* Generated By:JavaCC: Do not edit this line. Raw2.java */
 ...
 */
public class Raw2 implements net.sf.crsx.Parser, Raw2Constants {
        /** Factory. */
        ...
        public net.sf.crsx.Parser parser(net.sf.crsx.Factory<? extends net.sf.crsx.Term> f)
        {
                if (factory != null)
                {
                        net.sf.crsx.Parser parser = new Raw2().parser(f);
        ...
        public net.sf.crsx.Sink parse(net.sf.crsx.Sink sink, String category, java.io.Reader reader, String unit, int firstLine, int firstColumn, net.sf.crsx.util.ExtensibleMap<String, net.sf.crsx.Variable> bound) throws net.sf.crsx.CRSException, java.io.IOException
        {
                try
                {
                        ...
                        jj_input_stream.ReInit(reader, firstLine, firstColumn); token_source = new Raw2TokenManager(jj_input_stream); // hacks to update line and column numbers
	 ...
	 */
        public static void main(String[] args)
        {
                try
                {
                        if (args.length != 2)
                        {
                                System.err.println("Usage: Raw2 category input");
                                System.exit(2);
                        }
                        ...
                        net.sf.crsx.Parser parser = new Raw2();
...
/**
 * <em>Form</em> ::=  <a href="#N_Constructor">&lang;Constructor&rang;</a> <font color="red">:#C</font>   (  <font color="red">{FormUnparsedSorted}</font><font color="red">:raw</font>   <font color="red">{{#C}}</font>    <a href="#T_CONCRETE">CONCRETE</a><font color="red">$</font>   <a href="#N_FormPrec">&lang;FormPrec&rang;</a>    <a href="#N_InheritedRefs">&lang;InheritedRefs&rang;</a>   |  <font color="red">{FormConstruction}</font><font color="red">:raw</font>   <font color="red">{{#C}}</font>   (   <a href="#T_LPAREN">LPAREN</a>   (  <a href="#N_ScopeSorts">&lang;ScopeSorts&rang;</a>   |  <font color="red">{$Nil}</font>  )    <a href="#T_RPAREN">RPAREN</a>  |  <font color="red">{$Nil}</font>  )   <a href="#N_InheritedRefs">&lang;InheritedRefs&rang;</a>   )  <br>
 *  |  <font color="red">{FormUnparsedUnsorted}</font><font color="red">:raw</font>    <a href="#T_CONCRETE">CONCRETE</a><font color="red">$</font>   <a href="#N_FormPrec">&lang;FormPrec&rang;</a>    <a href="#N_InheritedRefs">&lang;InheritedRefs&rang;</a>  
 */
  final public net.sf.crsx.Sink N_Form(net.sf.crsx.Sink sink, net.sf.crsx.util.ExtensibleMap<String, net.sf.crsx.Variable> env) throws ParseException {
    ...
    try {
      ...
      case T_CON:
        ...
        switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
        case T_CONCRETE:
                        sink = sink .start(makeTConstructor(sink, t, raw("FormUnparsedSorted"), null)) ;
                        sink = sink .copy(b__C, true) ;
          t = jj_consume_token(T_CONCRETE);
                        sink = sink .start(makeTConstructor(sink, t, t.toString(), net.sf.crsx.CRS.STRING_SORT)) ;
        ...
        break;
      case T_CONCRETE:
                sink = sink .start(makeTConstructor(sink, t, raw("FormUnparsedUnsorted"), null)) ;
        t = jj_consume_token(T_CONCRETE);
                sink = sink .start(makeTConstructor(sink, t, t.toString(), net.sf.crsx.CRS.STRING_SORT)) ;
        sink = N_FormPrec(sink, env);
        sink = N_InheritedRefs(sink, env);
 ...
 *  |  <font color="red">{Unparsed}</font><font color="red">:raw</font>    <a href="#T_CONCRETE">CONCRETE</a><font color="red">$</font>   <a href="#N_Attributes">&lang;Attributes&rang;</a>   <br>
 ...
 */
  ...
  public Raw2TokenManager token_source;
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x10,0x8,0xc6,0x10,0x8,0xc0,0x10,0x8,0xcc0,0x300,0x10,0x8,0x0,0x0,0x0,0x0,0xcc0,0x10,0x8,0x0,0x3000,0x10,0x8,0xc000,0x10,0x8,0x3cf0000,0x10,0x8,0x3cc0000,0x10,0x8,0xc00000,0x0,0x300000,0x10,0x8,0xc00000,0x10,0x8,0x3c00000,0x10,0x8,0x0,0xc000000,0x10,0x8,0xf0000000,0x10,0x8,0xc0000000,0x10,0x8,0x0,0x0,0x10,0x8,0x0,0x10,0x8,0x0,0x10,0x8,0x0,0x0,0x0,0x0,0x10,0x8,0x0,0x0,0x0,0x0,0x10,0x8,0x0,0x0,0x10,0x8,0x0,0x0,0x0,0x10,0x8,0x0,0x0,0x10,0x8,0x0,0x10,0x8,0x0,0x10,0x8,0x0,0x10,0x8,0x0,0x10,0x8,0x0,0x10,0x8,0x0,0x10,0x8,0x0,0x0,0x10,0x8,0x0,0x0,0x10,0x8,0x0,0x0,0x10,0x8,0x0,0x10,0x8,0x0,0x0,0x0,0x10,0x8,0x0,0x0,0x10,0x8,0x0,0x0,0x10,0x8,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x10,0x8,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x10,0x8,0x0,0x0,0x10,0x8,0x0,0x0,0x0,0x10,0x8,0x0,0x10,0x8,0x0,0x0,0x10,0x8,0x0,0x0,0x10,0x8,0x0,0x0,0x10,0x8,0x0,0x10,0x8,0x0,0x0,0x10,0x8,0x0,0x0,0x0,0x10,0x8,0x0,0x10,0x8,0x0,0x10,0x8,0x0,0x10,0x8,0x0,0x10,0x8,0x0,0x10,0x8,0x0,0x0,0x10,0x8,0x0,0x0,0x10,0x8,0x0,0x0,0x10,0x8,0x0,0x0,0x10,0x8,0x0,0x10,0x8,0x0,0x10,0x8,0x0,0x10,0x8,0x0,0x10,0x8,0x0,0x0,0x10,0x8,0x0,0x10,0x8,0x0,0x10,0x8,0x0,0x10,0x8,0x0,0x10,0x8,0x0,0x0,0x10,0x8,0x0,0x0,0x10,0x8,0x0,0x0,0x10,0x8,0x0,0x0,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xf0,0x0,0x0,0x0,0x3,0x0,0x0,0x0,0xf0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x3,0x0,0x0,0xc,0x0,0x0,0xf0,0x0,0x0,0x0,0x0,0x300,0xc0,0x0,0x0,0xccc3c00,0x0,0x0,0x300,0x0,0x0,0x0,0xccc3c00,0x0,0x0,0x3c000,0x0,0xccc3000,0x0,0x0,0x0,0x3c000,0x0,0x0,0x30000,0x0,0x0,0xccc0000,0x0,0x0,0xcf00000,0x0,0x0,0xcc00000,0x0,0x0,0x3000000,0x0,0x0,0xc000000,0x0,0x0,0x0,0x30000000,0x0,0x0,0x0,0xc0000000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,};
   }
   private static void jj_la1_init_2() {
      jj_la1_2 = new int[] {0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x30f0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x30f0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xc,0x3,0x0,0x0,0xc,0x0,0x0,0x0,0x0,0x30f0,0x0,0x0,0x0,0xc0,0x0,0x0,0xf00,0xf00,0x0,0x0,0xc00f00,0x0,0x3cc00,0x3cc00,0x0,0x3cc00,0x3cc00,0x0,0x0,0xc00f00,0x0,0xc00,0x0,0x0,0x3cc00,0x3cc00,0x0,0x3cc00,0x3cc00,0x0,0x0,0x3000,0x0,0x0,0x0,0x3cc00,0x0,0x0,0xc0000,0x300000,0x30c00,0x0,0x0,0xc0000,0x0,0x0,0x0,0x300000,0x0,0x0,0x0,0xc00f00,0x0,0x0,0x3c000000,0x3000000,0x0,0x0,0x3c000000,0x0,0x0,0x0,0x30000000,0x0,0x0,0x0,0xf00,0xc0000000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,};
   }
   private static void jj_la1_init_3() {
      jj_la1_3 = new int[] {0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xf8180010,0x0,0x0,0x0,0x181800,0x0,0x181800,0x0,0xf8180010,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x18000,0x0,0x0,0x18000,0x0,0x0,0x6000000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x18000,0x0,0x0,0x0,0x0,0x0,0x0,0x600000,0x0,0x0,0x600000,0x0,0x0,0x0,0x181800,0x0,0x0,0x600000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x180010,0x0,0x0,0x0,0x781800,0x0,0x10,0x180010,0x0,0x0,0x0,0x781800,0x0,0x0,0x600000,0x0,0x781800,0x0,0x0,0x0,0x600000,0x0,0x0,0x600000,0x0,0x0,0x781800,0x0,0x0,0x781800,0x0,0x0,0x781800,0x0,0x0,0x1800000,0x0,0x0,0x600000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x
,0x0,0x0,0x0,0x80000000,0x0,0x0,0x0,0x400,0x0,0x0,0x0,0x400,0x0,0x0,0x1,0x100,0x30016000,0x0,0x0,0x30000000,0x0,0x0,0x0,0xffffe008,0xffffe008,0x0,0x0,0xffffe008,0x10,0xffffe018,0xffffe018,0x10,0xffffe018,0xffffe018,0x10,0xffffa008,0xffffe008,0x10,0x16008,0x0,0x0,0xffffe018,0xffffe018,0x10,0xffffe018,0xffffe018,0x10,0x12000,0x16000,0x0,0x0,0x40,0xffffe018,0x0,0x0,0xfffe8000,0xfffe8000,0xffffe018,0x0,0x0,0xfffe8000,0x0,0x0,0x40,0xfffe8000,0x0,0x0,0x40,0xffffe008,0x0,0x0,0x600,0x0,0x0,0x0,0x600,0x0,0x0,0x600,0x600,0x0,0x0,0x5,0xffffe808,0x2,0x0,0x0,0xffffa000,0x0,0x0,0x12000,0x0,0x0,0x12000,0x0,0x0,0x0,0x0,0x0,0xffffe000,0x0,0x0,0x12000,0x12000,0x0,0x0,0xfffe8000,0xfffe8000,0x0,0x0,0x8,0x8,0x0,0x0,0x41,0x41,0x0,0x0,0x4000,0x0,0x0,0x4000,0x0,0x0,0x4000,0x0,0x0,0x0,0x0,0x0,0x12000,0x12000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,};
   }
   private static void jj_la1_init_6() {
      jj_la1_6 = new int[] {0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x3447,0x0,0x0,0x0,0x40,0x0,0x44,0x0,0x3447,0x0,0x0,0x0,0x0,0x0,0x0,0x8,0x0,0x0,0x192240,0x0,0x0,0x192240,0x0,0x0,0x82040,0x0,0x0,0x0,0x0,0x82040,0x0,0x0,0x192240,0x0,0x0,0x0,0x0,0x0,0x0,0x2f,0x0,0x0,0x2f,0x0,0x0,0x0,0x40,0x0,0x0,0x2f,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x40,0x0,0x0,0x0,0x6f,0x0,0x0,0x40,0x0,0x0,0x0,0x6f,0x0,0x0,0x2f,0x0,0x6f,0x0,0x0,0x0,0x2f,0x0,0x0,0x2f,0x0,0x0,0x6f,0x0,0x0,0x6f,0x0,0x0,0x6f,0x0,0x0,0x10,0x0,0x0,0x2f,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x3440,0x0,0x0,0x0,0x0,0x0,0x0,0x347f,0x347f,0x0,0x0,0x347f,0x0,0x347f,0x347f,0x0,0x347f,0x347f,0x0,0x7f,0x347f,0x0,0x3450,0x0,0x0,0x347f,0x347f,0x0,0x347f,0x347f,0x0,0x40,0x3440,0x0,0x0,0x0,0x347f,0x0,0x0,0x2f,0x2f,0x347f,0x0,0x0,0x2f,0x0,0x0,0x0,0x2f,0x0,0x0,0x0,0x347f,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x347f,0x0,0x0,0x0,0x206f,0x0,0x0,0x40,0x0,0x0,0x40,0x0,0x0,0x200,0x0,0x0,0x346f,0x0,0x0,0x40,0x40,0x0,0x0,0x2f,0x2f,0x0,0x0,0x10,0x10,0x0,0x0,0x0,0x0,0x0,0x0,0x3400,0x0,0x0,0x1400,0x0,0x0,0x400,0x0,0x0,0x2000,0x0,0x0,0x80040,0x80040,0x0,0x0,0x100000,0x0,0x0,0x1e00000,0x0,0x0,0x1e00000,0x0,0x0,0x1a00000,0x0,0x0,0x1a00000,0x1a00000,0x0,0x0,0x1c00000,0x1c00000,0x0,0x0,0x1200000,0x1200000,0x0,0x0,0x1a00000,0x1a00000,};
   }

  /** Constructor with InputStream. */
  public Raw2(java.io.InputStream stream) {
     this(stream, null);
  }
  /** Constructor with InputStream and supplied encoding */
  public Raw2(java.io.InputStream stream, String encoding) {
    try { jj_input_stream = new SimpleCharStream(stream, encoding, 1, 1); } catch(java.io.UnsupportedEncodingException e) { throw new RuntimeException(e); }
    token_source = new Raw2TokenManager(jj_input_stream);
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  /** Constructor. */
  public Raw2(java.io.Reader stream) {
  ...
  public Raw2(Raw2TokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  /** Reinitialise. */
  public void ReInit(Raw2TokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;

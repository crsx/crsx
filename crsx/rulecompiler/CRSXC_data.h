...
typedef enum {FunOf_M_Binder_State = 0, VarOf_M_Binder_State = 1, Data_M_OUTER, Data_M_REUSING, Data_M_COPYING, Data_M_NO_xREUSE} EnumOf_M_Binder_State;
...
typedef enum {FunOf_M_Pattern_Stage = 0, VarOf_M_Pattern_Stage = 1, Data_M_SUBMATCH, Data_M_DISPATCH, Data_M_MATCH, Data_M_CASE} EnumOf_M_Pattern_Stage;
...
typedef enum {FunOf_M_Reified_xBinder = 0, VarOf_M_Reified_xBinder = 1, Data_M_BINDER, Data_M_ARGUMENT, Data_M_META_REQUIRED_VARIABLE} EnumOf_M_Reified_xBinder;
...
typedef enum {FunOf_M_Reified_xDeclaration = 0, VarOf_M_Reified_xDeclaration = 1, Data_M_FUNCTION, Data_M_POLYMORPHIC, Data_M_DATA} EnumOf_M_Reified_xDeclaration;
...
typedef enum {FunOf_M_Reified_xForm = 0, VarOf_M_Reified_xForm = 1, Data_M_SORT_SET, Data_M_SORT_ALLOWS_VARIABLES, Data_M_FORM} EnumOf_M_Reified_xForm;
...
typedef enum {FunOf_M_Reified_xFormArgument = 0, VarOf_M_Reified_xFormArgument = 1, Data_M_FORM_BINDER, Data_M_FORM_ARGUMENT} EnumOf_M_Reified_xFormArgument;
...
typedef enum {FunOf_M_Reified_xOccurrence = 0, VarOf_M_Reified_xOccurrence = 1, Data_M_META_USE, Data_M_OTHER} EnumOf_M_Reified_xOccurrence;
...
typedef enum {FunOf_M_Reified_xPromiscuity = 0, VarOf_M_Reified_xPromiscuity = 1, Data_M_LINEAR, Data_M_PROMISCUOUS} EnumOf_M_Reified_xPromiscuity;
...
typedef enum {FunOf_M_Reified_xTerm = 0, VarOf_M_Reified_xTerm = 1, Data_M_META_APPLICATION, Data_M_EVALUATOR, Data_M_FreshReuseOrigin, Data_M_PROPERTY_REF, Data_M_PROPERTY, Data_M_PROPERTY_NOT, Data_M_CONSTRUCTION, Data_M_LITERAL, Data_M_VARIABLE_USE} EnumOf_M_Reified_xTerm;
...
typedef enum {FunOf_M_Reified_xUse = 0, VarOf_M_Reified_xUse = 1, Data_M_DISCARD, Data_M_USE, Data_M_NA, Data_M_LINK, Data_M_NOLINK} EnumOf_M_Reified_xUse;
...
typedef enum {FunOf_M_SPrimitive = 0, VarOf_M_SPrimitive = 1, Data_M_E_xNull, Data_M_E_xNil, Data_M_E_xForgivableError, Data_M_E_xStringLessThan, Data_M_E_xFromFirst, Data_M_E_xToFirst, Data_M_E_xVariableNameIs, Data_M_E_xSplit, Data_M_E_xRescape, Data_M_E_xUpCase, Data_M_E_xDownCase, Data_M_E_xReplace, Data_M_E_xTrim, Data_M_E_xKeys, Data_M_E_xParseURL, Data_M_E_xEcho, Data_M_E_xDeepEqual, Data_M_E_xHashCode, Data_M_E_xConcat, Data_M_E_xC, Data_M_E_xEqual, Data_M_E_xNotEqual, Data_M_E_xLessThan, Data_M_E_xGreaterThan, Data_M_E_xLessThanOrEqual, Data_M_E_xSameVariable, Data_M_E_xLesserVariable, Data_M_E_xGreaterThanOrEqual, Data_M_E_xIf, Data_M_E_xIfZero, Data_M_E_xIfEmpty, Data_M_E_xSquash, Data_M_E_xContains, Data_M_E_xStartsWith, Data_M_E_xEndsWith, Data_M_E_xMatchRegex, Data_M_E_xLength, Data_M_E_xSubstring, Data_M_E_xEscape, Data_M_E_xMangle, Data_M_E_xBeforeFirst, Data_M_E_xAfterFirst, Data_M_E_xPlus, Data_M_E_xMinus, Data_M_E_xTimes, Data_M_E_xAbsolute, Data_M_E_xDecimal, Data_M_E_xDiv, Data_M_E_xMod, Data_M_E_xHex, Data_M_E_xBitAnd, Data_M_E_xBitOr, Data_M_E_xBitXOr, Data_M_E_xBitNot, Data_M_E_xBitMinus, Data_M_E_xBitSubSetEq, Data_M_E_xLoadTerm, Data_M_E_xSaveTerm, Data_M_E_xIsZero, Data_M_E_xIsEmpty, Data_M_E_xNumericEqual, Data_M_E_xError, Data_M_E_xTrace, Data_M_E_xFormatNumber, Data_M_E_xPassLocationProperties, Data_M_E_xGet, Data_M_E_xGetRef, Data_M_E_xIfDef, Data_M_E_xShow, Data_M_E_xFormat, Data_M_E_xFreeVariables, Data_M_E_xIntersectVariables, Data_M_E_xUnionVariables, Data_M_E_xExceptVariables, Data_M_E_xMatch, Data_M_E_xCall, Data_M_E_xTryCall, Data_M_E_xCast} EnumOf_M_SPrimitive;
...
extern struct _ConstructionDescriptor descriptor_M_E_xDeepEqual;
...
typedef enum {FunOf_M_STRING_xENTRY = 0, VarOf_M_STRING_xENTRY = 1, Data_M_STRING_xVALUE, Data_M_LIST_xSTRING, Data_M_NUM_xVALUE, Data_M_VARIABLE, Data_M_LIST_xVARIABLE, Data_M_PROPERTY_xVARIABLE, Data_M_NO} EnumOf_M_STRING_xENTRY;
...
typedef enum {FunOf_M_T_xREUSE_xSORT = 0, VarOf_M_T_xREUSE_xSORT = 1, Data_M_T_xNO_xREUSE, Data_M_T_xREUSE} EnumOf_M_T_xREUSE_xSORT;
...
typedef enum {FunOf_M_Text_Part = 0, VarOf_M_Text_Part = 1, Data_M__sTextEmbed, Data_M__sTextBreak, Data_M__sTextSeparator, Data_M__sTextGroup, Data_M__sTextIndent, Data_M__sTextString, Data_M__sTextChars} EnumOf_M_Text_Part;
...
typedef enum {FunOf_M_VARIABLE_xENTRY = 0, VarOf_M_VARIABLE_xENTRY = 1, Data_M_FREE, Data_M_BOUNDREUSE, Data_M_FRESH, Data_M_FRESHREUSE, Data_M_SUB, Data_M_BOUND} EnumOf_M_VARIABLE_xENTRY;

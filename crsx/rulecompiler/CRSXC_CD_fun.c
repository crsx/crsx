...
int step_M_D__check__sort_s1(Sink sink__V1, Term term__V2)
{
  ...
  switch (choice__V4)
  {
    case Data_M_SORT_PROPERTY: { /* Function CDEFS-D-check-sort-1$D-check-sort$1$SORT-PROPERTY case SORT-PROPERTY */
      ...
      Hashset namedFV__V13 = LINK_VARIABLESET(sink__V1->context, asConstruction(term__V2)->properties->namedFreeVars);
      Hashset varFV__V14 = LINK_VARIABLESET(sink__V1->context, asConstruction(term__V2)->properties->variableFreeVars);
    ...
    break; } case Data_M_SORT_VARIABLE: { /* Function CDEFS-D-check-sort-2$D-check-sort$1$SORT-VARIABLE case SORT-VARIABLE */
      ...
      Hashset namedFV__V21 = LINK_VARIABLESET(sink__V1->context, asConstruction(term__V2)->properties->namedFreeVars);
      Hashset varFV__V22 = LINK_VARIABLESET(sink__V1->context, asConstruction(term__V2)->properties->variableFreeVars);
      UNLINK(sink__V1->context, term__V2);
    ...
    break; } case Data_M_SORT: { /* Function CDEFS-D-check-sort-3$D-check-sort$1$SORT case SORT */
      ...
      Hashset namedFV__V30 = LINK_VARIABLESET(sink__V1->context, asConstruction(term__V2)->properties->namedFreeVars);
      Hashset varFV__V31 = LINK_VARIABLESET(sink__V1->context, asConstruction(term__V2)->properties->variableFreeVars);
      UNLINK(sink__V1->context, term__V2);
...
int step_M_D__check__sort_s2(Sink sink__V32, Term term__V33)
{
  ...
  do {
    ...
    Hashset namedFV__V40 = LINK_VARIABLESET(sink__V32->context, asConstruction(term__V33)->properties->namedFreeVars);
    Hashset varFV__V41 = LINK_VARIABLESET(sink__V32->context, asConstruction(term__V33)->properties->variableFreeVars);
...
int step_M_D__check__sort_s3(Sink sink__V43, Term term__V44)
{
  ...
  do {
    ...
    Hashset namedFV__V52 = LINK_VARIABLESET(sink__V43->context, asConstruction(term__V44)->properties->namedFreeVars);
    Hashset varFV__V53 = LINK_VARIABLESET(sink__V43->context, asConstruction(term__V44)->properties->variableFreeVars);
...
int step_M_D__check__sort_s4(Sink sink__V54, Term term__V55)
{
  ...
  do {
    ...
    Hashset namedFV__V61 = LINK_VARIABLESET(sink__V54->context, asConstruction(term__V55)->properties->namedFreeVars);
    Hashset varFV__V62 = LINK_VARIABLESET(sink__V54->context, asConstruction(term__V55)->properties->variableFreeVars);

/* C HEADER FOR CRSX CRSXC MODULE CD. */
#ifndef CRSX__M_CRSXC_M_CD_H
#define CRSX__M_CRSXC_M_CD_H
...
struct _Con_M_D__check__sort_s2 {struct _Construction construction; Term sub[4]; Variable binder[0];};
extern struct _ConstructionDescriptor descriptor_M_D__check__sort_s2;
extern int step_M_D__check__sort_s2(Sink,Term);

/* FUNCTION CDEFS-D-check-sort-1 HEADER DECLARATIONS. */
#define STRUCT_Con_M_D__check__sort_s3 struct _Con_M_D__check__sort_s3
struct _Con_M_D__check__sort_s3 {struct _Construction construction; Term sub[5]; Variable binder[0];};
...
#endif
/* END OF C HEADER FOR CRSX CRSXC MODULE CD. */
#endif

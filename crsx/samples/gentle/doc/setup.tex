...
\lstdefinelanguage{HACS}{basicstyle=\rm,%
  inputencoding=utf8,sensitive,%
  %identifierstyle=\textit,%
  string=[b]{"},morestring=[b]{'},morestring=[s]{[}{]},upquote=true,stringstyle=\ttfamily,%
  showstringspaces=false,%
  %moredelim=[s][\texttt]{⟦}{⟧},%
  %moredelim=[s][\textit]{⟨}{⟩},%
  comment=[l]{//},morecomment=[s]{/*}{*/},commentstyle=\color{gray}\itseries,texcl=true,%
  keywordstyle=\color{black}\rm\textbf,%

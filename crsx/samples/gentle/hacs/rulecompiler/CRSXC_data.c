...
ConstructionDescriptor sortCon_M_Binder_State[] = {NULL, NULL, &descriptor_M_OUTER, &descriptor_M_REUSING, &descriptor_M_NO_xREUSE, &descriptor_M_COPYING,  NULL};
char *sortNam_M_Binder_State[] = {NULL, NULL,  "OUTER" ,  "REUSING" ,  "NO_REUSE" ,  "COPYING" ,  NULL};
char *sortInt_M_Binder_State[] = {NULL, NULL, "_M_OUTER", "_M_REUSING", "_M_NO_xREUSE", "_M_COPYING",  NULL};
...
ConstructionDescriptor sortCon_M_Pattern_Stage[] = {NULL, NULL, &descriptor_M_MATCH, &descriptor_M_SUBMATCH, &descriptor_M_CASE, &descriptor_M_DISPATCH,  NULL};
char *sortNam_M_Pattern_Stage[] = {NULL, NULL,  "MATCH" ,  "SUBMATCH" ,  "CASE" ,  "DISPATCH" ,  NULL};
char *sortInt_M_Pattern_Stage[] = {NULL, NULL, "_M_MATCH", "_M_SUBMATCH", "_M_CASE", "_M_DISPATCH",  NULL};
...
ConstructionDescriptor sortCon_M_Reified_xBinder[] = {NULL, NULL, &descriptor_M_ARGUMENT, &descriptor_M_BINDER, &descriptor_M_META_REQUIRED_VARIABLE,  NULL};
char *sortNam_M_Reified_xBinder[] = {NULL, NULL,  "ARGUMENT" ,  "BINDER" ,  "META-REQUIRED-VARIABLE" ,  NULL};
char *sortInt_M_Reified_xBinder[] = {NULL, NULL, "_M_ARGUMENT", "_M_BINDER", "_M_META_REQUIRED_VARIABLE",  NULL};
...
ConstructionDescriptor sortCon_M_Reified_xDeclaration[] = {NULL, NULL, &descriptor_M_FUNCTION, &descriptor_M_DATA, &descriptor_M_POLYMORPHIC,  NULL};
char *sortNam_M_Reified_xDeclaration[] = {NULL, NULL,  "FUNCTION" ,  "DATA" ,  "POLYMORPHIC" ,  NULL};
char *sortInt_M_Reified_xDeclaration[] = {NULL, NULL, "_M_FUNCTION", "_M_DATA", "_M_POLYMORPHIC",  NULL};
...
ConstructionDescriptor sortCon_M_Reified_xForm[] = {NULL, NULL, &descriptor_M_SORT_ALLOWS_VARIABLES, &descriptor_M_SORT_SET, &descriptor_M_FORM,  NULL};
char *sortNam_M_Reified_xForm[] = {NULL, NULL,  "SORT-ALLOWS-VARIABLES" ,  "SORT-SET" ,  "FORM" ,  NULL};
char *sortInt_M_Reified_xForm[] = {NULL, NULL, "_M_SORT_ALLOWS_VARIABLES", "_M_SORT_SET", "_M_FORM",  NULL};
...
ConstructionDescriptor sortCon_M_Reified_xFormArgument[] = {NULL, NULL, &descriptor_M_FORM_ARGUMENT, &descriptor_M_FORM_BINDER,  NULL};
char *sortNam_M_Reified_xFormArgument[] = {NULL, NULL,  "FORM-ARGUMENT" ,  "FORM-BINDER" ,  NULL};
char *sortInt_M_Reified_xFormArgument[] = {NULL, NULL, "_M_FORM_ARGUMENT", "_M_FORM_BINDER",  NULL};
...
ConstructionDescriptor sortCon_M_Reified_xOccurrence[] = {NULL, NULL, &descriptor_M_OTHER, &descriptor_M_META_USE,  NULL};
char *sortNam_M_Reified_xOccurrence[] = {NULL, NULL,  "OTHER" ,  "META-USE" ,  NULL};
char *sortInt_M_Reified_xOccurrence[] = {NULL, NULL, "_M_OTHER", "_M_META_USE",  NULL};
...
ConstructionDescriptor sortCon_M_Reified_xPromiscuity[] = {NULL, NULL, &descriptor_M_PROMISCUOUS, &descriptor_M_LINEAR,  NULL};
char *sortNam_M_Reified_xPromiscuity[] = {NULL, NULL,  "PROMISCUOUS" ,  "LINEAR" ,  NULL};
char *sortInt_M_Reified_xPromiscuity[] = {NULL, NULL, "_M_PROMISCUOUS", "_M_LINEAR",  NULL};
...
ConstructionDescriptor sortCon_M_Reified_xTerm[] = {NULL, NULL, &descriptor_M_FreshReuseOrigin, &descriptor_M_EVALUATOR, &descriptor_M_META_APPLICATION, &descriptor_M_LITERAL, &descriptor_M_VARIABLE_USE, &descriptor_M_CONSTRUCTION, &descriptor_M_PROPERTY, &descriptor_M_PROPERTY_NOT, &descriptor_M_PROPERTY_REF,  NULL};
char *sortNam_M_Reified_xTerm[] = {NULL, NULL,  "FreshReuseOrigin" ,  "EVALUATOR" ,  "META-APPLICATION" ,  "LITERAL" ,  "VARIABLE-USE" ,  "CONSTRUCTION" ,  "PROPERTY" ,  "PROPERTY-NOT" ,  "PROPERTY-REF" ,  NULL};
char *sortInt_M_Reified_xTerm[] = {NULL, NULL, "_M_FreshReuseOrigin", "_M_EVALUATOR", "_M_META_APPLICATION", "_M_LITERAL", "_M_VARIABLE_USE", "_M_CONSTRUCTION", "_M_PROPERTY", "_M_PROPERTY_NOT", "_M_PROPERTY_REF",  NULL};
...
ConstructionDescriptor sortCon_M_Reified_xUse[] = {NULL, NULL, &descriptor_M_NOLINK, &descriptor_M_USE, &descriptor_M_DISCARD, &descriptor_M_LINK, &descriptor_M_NA,  NULL};
char *sortNam_M_Reified_xUse[] = {NULL, NULL,  "NOLINK" ,  "USE" ,  "DISCARD" ,  "LINK" ,  "NA" ,  NULL};
char *sortInt_M_Reified_xUse[] = {NULL, NULL, "_M_NOLINK", "_M_USE", "_M_DISCARD", "_M_LINK", "_M_NA",  NULL};
...
int conBindOffs_M_PROPERTY_xVARIABLE[] = {0 , 0 , 0};
...
struct _ConstructionDescriptor descriptor_M_PROPERTY_xVARIABLE = {&sort_M_STRING_xENTRY, Data_M_PROPERTY_xVARIABLE, 2, sizeof(STRUCT_Con_M_PROPERTY_xVARIABLE), conBindOffs_M_PROPERTY_xVARIABLE, &nameFun_M_PROPERTY_xVARIABLE, &dataStep};
char *name_M_NO =  "NO" ;
...
ConstructionDescriptor sortCon_M_STRING_xENTRY[] = {NULL, NULL, &descriptor_M_PROPERTY_xVARIABLE, &descriptor_M_NO, &descriptor_M_STRING_xVALUE, &descriptor_M_LIST_xSTRING, &descriptor_M_NUM_xVALUE, &descriptor_M_VARIABLE, &descriptor_M_LIST_xVARIABLE,  NULL};
char *sortNam_M_STRING_xENTRY[] = {NULL, NULL,  "PROPERTY_VARIABLE" ,  "NO" ,  "STRING_VALUE" ,  "LIST_STRING" ,  "NUM_VALUE" ,  "VARIABLE" ,  "LIST_VARIABLE" ,  NULL};
char *sortInt_M_STRING_xENTRY[] = {NULL, NULL, "_M_PROPERTY_xVARIABLE", "_M_NO", "_M_STRING_xVALUE", "_M_LIST_xSTRING", "_M_NUM_xVALUE", "_M_VARIABLE", "_M_LIST_xVARIABLE",  NULL};
...
ConstructionDescriptor sortCon_M_T_xREUSE_xSORT[] = {NULL, NULL, &descriptor_M_T_xREUSE, &descriptor_M_T_xNO_xREUSE,  NULL};
char *sortNam_M_T_xREUSE_xSORT[] = {NULL, NULL,  "T_REUSE" ,  "T_NO_REUSE" ,  NULL};
char *sortInt_M_T_xREUSE_xSORT[] = {NULL, NULL, "_M_T_xREUSE", "_M_T_xNO_xREUSE",  NULL};
...
ConstructionDescriptor sortCon_M_Text_Part[] = {NULL, NULL, &descriptor_M__sTextString, &descriptor_M__sTextBreak, &descriptor_M__sTextEmbed, &descriptor_M__sTextIndent, &descriptor_M__sTextGroup, &descriptor_M__sTextSeparator, &descriptor_M__sTextChars,  NULL};
char *sortNam_M_Text_Part[] = {NULL, NULL,  "$TextString" ,  "$TextBreak" ,  "$TextEmbed" ,  "$TextIndent" ,  "$TextGroup" ,  "$TextSeparator" ,  "$TextChars" ,  NULL};
char *sortInt_M_Text_Part[] = {NULL, NULL, "_M__sTextString", "_M__sTextBreak", "_M__sTextEmbed", "_M__sTextIndent", "_M__sTextGroup", "_M__sTextSeparator", "_M__sTextChars",  NULL};
...
ConstructionDescriptor sortCon_M_VARIABLE_xENTRY[] = {NULL, NULL, &descriptor_M_SUB, &descriptor_M_BOUND, &descriptor_M_FRESHREUSE, &descriptor_M_FRESH, &descriptor_M_BOUNDREUSE, &descriptor_M_FREE,  NULL};
char *sortNam_M_VARIABLE_xENTRY[] = {NULL, NULL,  "SUB" ,  "BOUND" ,  "FRESHREUSE" ,  "FRESH" ,  "BOUNDREUSE" ,  "FREE" ,  NULL};
char *sortInt_M_VARIABLE_xENTRY[] = {NULL, NULL, "_M_SUB", "_M_BOUND", "_M_FRESHREUSE", "_M_FRESH", "_M_BOUNDREUSE", "_M_FREE",  NULL};

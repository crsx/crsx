...
int step_M_Forms_Constructors(Sink sink__V571, Term term__V572)
{
  ...
  switch (choice__V574)
  {
    case Data_M__sCons: { /* Function DEFS-Forms-Constructors-1$Forms-Constructors$$Cons case $Cons */
...
int step_M_STRING(Sink sink__V1094, Term term__V1095)
{
  int term__V1095_count = LINK_COUNT(term__V1095); permitUnusedInt(term__V1095_count);
  do {
    /* Contraction rule DEFS-STRING-1. */
    ASSERT(sink__V1094->context, !strcmp(SYMBOL(term__V1095),  "STRING" ));
    ...
    UNLINK_SUB(sink__V1094->context, term__V1095,  0); NORMALIZE(sink__V1094->context, sub__V1096); SUB(term__V1095,  0) = LINK(sink__V1094->context, sub__V1096);
    /* sub__V1096 = &#1 */
    NamedPropertyLink namedP__V1097 = LINK_NamedPropertyLink(sink__V1094->context, NAMED_PROPERTIES(term__V1095));
    VariablePropertyLink varP__V1098 = LINK_VariablePropertyLink(sink__V1094->context, VARIABLE_PROPERTIES(term__V1095));
    UNLINK(sink__V1094->context, term__V1095);
    { START(sink__V1094, _M__sTextCons);
      { START(sink__V1094, _M__sTextChars);
        LITERAL(sink__V1094,  " " ); END(sink__V1094, _M__sTextChars); }
      { START(sink__V1094, _M__sTextCons);
        { START(sink__V1094, _M__sTextString);
          { START(sink__V1094, _M__sTextCons);
            { START(sink__V1094, _M__sTextChars);
              { char *str__V1099;
                FORCE(sink__V1094->context, sub__V1096);
                {str__V1099 = makeEscaped(sink__V1094->context, SYMBOL(sub__V1096));
                  UNLINK(sink__V1094->context, sub__V1096);}
                LITERALU(sink__V1094, str__V1099); }
              END(sink__V1094, _M__sTextChars); }
            { START(sink__V1094, _M__sTextNil);
              END(sink__V1094, _M__sTextNil); }
            END(sink__V1094, _M__sTextCons); }
          END(sink__V1094, _M__sTextString); }
        { START(sink__V1094, _M__sTextCons);
          { START(sink__V1094, _M__sTextChars);
            LITERAL(sink__V1094,  " " ); END(sink__V1094, _M__sTextChars); }
          { START(sink__V1094, _M__sTextNil);
        ...
        END(sink__V1094, _M__sTextCons); }
      END(sink__V1094, _M__sTextCons); }
    UNLINK_NamedPropertyLink(sink__V1094->context, namedP__V1097); UNLINK_VariablePropertyLink(sink__V1094->context, varP__V1098);
    return 1;
  } while (0);
  return 0;
}
...
int step_M_Sort__name_s1(Sink sink__V1100, Term term__V1101)
{
  int term__V1101_count = LINK_COUNT(term__V1101); permitUnusedInt(term__V1101_count);
  do {
    /* Contraction rule DEFS-Sort-name-1. */
    ASSERT(sink__V1100->context, !strcmp(SYMBOL(term__V1101),  "Sort-name$1" ));
    Term sub__V1102 = LINK(sink__V1100->context, SUB(term__V1101, 0)); int sub__V1102_count = term__V1101_count*LINK_COUNT(sub__V1102); permitUnusedInt(sub__V1102_count);
    /* sub__V1102 = &#11 */
    Term sub__V1103 = SUB(term__V1101, 1); permitUnusedTerm(sub__V1103); int sub__V1103_count = term__V1101_count*LINK_COUNT(sub__V1103); permitUnusedInt(sub__V1103_count);
    /* sub__V1103 = &#12 */
    NamedPropertyLink namedP__V1104 = LINK_NamedPropertyLink(sink__V1100->context, NAMED_PROPERTIES(term__V1101));
    VariablePropertyLink varP__V1105 = LINK_VariablePropertyLink(sink__V1100->context, VARIABLE_PROPERTIES(term__V1101));
    UNLINK(sink__V1100->context, term__V1101);
    { START(sink__V1100, _M_TOKEN);
      COPY(sink__V1100, sub__V1102);END(sink__V1100, _M_TOKEN); }
    UNLINK_NamedPropertyLink(sink__V1100->context, namedP__V1104); UNLINK_VariablePropertyLink(sink__V1100->context, varP__V1105);
    return 1;
  } while (0);
  return 0;
}
...
int step_M_UnVariable_s1(Sink sink__V1106, Term term__V1107)
{
  int term__V1107_count = LINK_COUNT(term__V1107); permitUnusedInt(term__V1107_count);
  do {
    /* Contraction rule DEFS-UnVariable-1. */
    ASSERT(sink__V1106->context, !strcmp(SYMBOL(term__V1107),  "UnVariable$1" ));
    Term sub__V1108 = LINK(sink__V1106->context, SUB(term__V1107, 0)); int sub__V1108_count = term__V1107_count*LINK_COUNT(sub__V1108); permitUnusedInt(sub__V1108_count);
    CRSX_CHECK_SORT(sink__V1106->context, sub__V1108, &sort_M_Reified_xVariable); /* sub__V1108 = &#11 */
    NamedPropertyLink namedP__V1109 = LINK_NamedPropertyLink(sink__V1106->context, NAMED_PROPERTIES(term__V1107));
    VariablePropertyLink varP__V1110 = LINK_VariablePropertyLink(sink__V1106->context, VARIABLE_PROPERTIES(term__V1107));
    UNLINK(sink__V1106->context, term__V1107);
    COPY(sink__V1106, sub__V1108);UNLINK_NamedPropertyLink(sink__V1106->context, namedP__V1109); UNLINK_VariablePropertyLink(sink__V1106->context, varP__V1110);
    return 1;
  } while (0);
  return 0;
}
